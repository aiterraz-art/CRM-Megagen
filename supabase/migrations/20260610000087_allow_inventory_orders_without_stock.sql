...
ADD COLUMN IF NOT EXISTS allow_sale_without_stock boolean;

UPDATE public.inventory
SET allow_sale_without_stock = false
WHERE allow_sale_without_stock IS NULL;

ALTER TABLE public.inventory
ALTER COLUMN allow_sale_without_stock SET DEFAULT false,
ALTER COLUMN allow_sale_without_stock SET NOT NULL;
