...
export const PERMISSION_CATALOG: PermissionDefinition[] = [
    ...
    { key: 'VIEW_TEAM_ACTIVITY', module: 'field', label: 'Ver Actividad del Equipo', desc: 'Ver visitas, tareas y registros de contacto de todo el equipo (vs solo propios).' },
    { key: 'MANAGE_TEAM_ACTIVITY', module: 'field', label: 'Gestionar Actividad del Equipo', desc: 'Crear, editar y eliminar visitas y tareas de otros usuarios.' },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
    ...
    facturador: [
        ...
        'VIEW_SCHEDULE', 'VIEW_TEAM_ACTIVITY', 'MANAGE_TEAM_ACTIVITY', 'CONVERT_COLD_VISITS',
