...
const AdministrativeDashboard = () => {
    ...
    const fetchDashboard = useCallback(async () => {
        try {
            ...
            alert(`Error cargando dashboard administrativo: ${error?.message || 'desconocido'}`);
        }
    }, []);
    ...
    if (loading) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-4">
                ...
                <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Cargando panel administrativo...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8 w-full mx-auto px-4 pb-12">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-black text-gray-900 tracking-tight">Dashboard Administrativo</h1>
