...
export const UserProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const fetchPermissions = async (role: string) => {
        ...
        const defaults: Record<string, string[]> = {
            ...
            'facturador': ['UPLOAD_EXCEL', 'MANAGE_INVENTORY', 'MANAGE_PRICING', 'MANAGE_DISPATCH', 'VIEW_ALL_CLIENTS', 'VIEW_OPERATIONS', 'MANAGE_COLLECTIONS', 'VIEW_KIT_LOANS', 'MANAGE_KIT_LOANS', 'VIEW_SIZE_CHANGES', 'MANAGE_SIZE_CHANGES', 'VIEW_PURCHASE_ORDERS'],
